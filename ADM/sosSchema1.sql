...
VALUES
  ...
  ('Dipirona 1', 'Analgesico', 'mtakushi'),
  ('Dipirona 2', 'Analgesico', 'mtakushi'),
  ('Dipirona 3', 'Analgesico', 'mtakushi'),
  ('Dipirona Forte', 'Analgesico', 'mtakushi'),
  ('Dipirona Strong', 'Analgesico', 'mtakushi'),
